...
const email: string = "testneed@mail.com";
const content = "This is a test with password";
...
describe("Neccesary for other proves", () => {
  ...
  describe("POST /api/v1/message/decipher", () => {
    test("Should return 200 with correct unique string and password", async () => {
    ...
    test("Should return 400 without fields, without uniqueString, without api key, with nonexistent api key, without password for message with password", async () => {
      const fields = [
        {},
        { apiKey },
        { uniqueString },
